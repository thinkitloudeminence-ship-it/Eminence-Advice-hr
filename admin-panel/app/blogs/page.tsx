...
const ReactQuill = dynamic(() => import('react-quill'), { ssr: false })
if (typeof window !== 'undefined') require('react-quill/dist/quill.snow.css')
                      ...
                      <Stack direction="row" spacing={2} alignItems="center">
                        ...
                        <Box>
                          <Button size="small" variant="outlined" startIcon={<Edit />}
                            onClick={() => handleEdit(blog)}
                            sx={{ mr: 1, borderColor: '#ff6b35', color: '#ff6b35' }}>Edit</Button>
        ...
        {activeTab === 1 && (
          <Box sx={{ p: 3 }}>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <TextField fullWidth multiline rows={2} label="Excerpt *" required
                  value={formData.excerpt}
                  onChange={e => setFormData({ ...formData, excerpt: e.target.value })}
                  helperText="Short summary (max 1000 chars) shown in blog listings" />
              </Grid>
              ...
              <Grid item xs={12}>
                <Typography variant="subtitle2" gutterBottom>Content *</Typography>
                <ReactQuill theme="snow" value={formData.content} modules={modules} formats={formats}
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <TextField fullWidth multiline rows={2} label="Meta Description" value={seoData.metaDescription}
                  onChange={e => setSeoData({ ...seoData, metaDescription: e.target.value })}
